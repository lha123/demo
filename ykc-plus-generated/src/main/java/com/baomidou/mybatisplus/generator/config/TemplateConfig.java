...
public class TemplateConfig {
    ...
    private TemplateConfig() {
        ...
        this.repo = ConstVal.TEMPLATE_REPO;
        this.repoImpl = ConstVal.TEMPLATE_REPO_IMPL;
    ...
    public static class Builder implements IConfigBuilder<TemplateConfig> {
         ...
         * 设置service模板路径
         *
         * @param repoTemplate     service接口模板路径
         * @return this
         */
        public Builder repo(@NotNull String repoTemplate) {
            this.templateConfig.repo = repoTemplate;
            return this;
        }
         ...
         * 设置serviceImpl模板路径
         *
         * @param repoImplTemplate service实现类模板路径
         * @return this
         */
        public Builder repoImpl(@NotNull String repoImplTemplate) {
            this.templateConfig.repoImpl = repoImplTemplate;
            return this;
        }
