...
public class TableInfo {
    ...
    public void processTable() {
        ...
        this.repoName = strategyConfig.repo().getConverterRepoFileName().convert(entityName);
        this.repoImplName = strategyConfig.repo().getConverterRepoImplFileName().convert(entityName);
